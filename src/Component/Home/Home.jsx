...
function Home() {
  return (
     ...
     <button className='hover:z-50 transition-all duration-300 ease-in-out  hover:scale-125 bg-purple-600 p-2 rounded-md text-white xl:ml-[200px] lg:ml-[160px] md:ml-[130px] sm:mx-auto sm:mr-[20px]  ml-[130px] mr-[30px] font-outfit font-extralight' >
        Resume
     </button>
     </a>
     <a href='#'>
     ...
     <img src='homeImage.png' className=' w-[300px] md:w-[400px] md:whitespace-normal sm:w-200 sm:ml-[60px]'/>
     <div>
     </div>
     </div>
  ) 
