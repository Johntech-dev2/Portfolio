...
function Home() {
  return (
     ...
     <button className='hover:z-50 transition-all duration-300 ease-in-out  hover:scale-125 bg-purple-600 p-2 rounded-md text-white xl:ml-[200px] lg:ml-[160px] md:ml-[130px] sm:ml-[20px] sm:mr-[20px]    ml-[100px] mr-[30px] font-outfit font-extralight' >
        Resume
     </button>
     </a>
     <a href='#'>
